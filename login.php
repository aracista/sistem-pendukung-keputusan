...
if($_POST){
	...
	if($login->login()){
		...
		?>
<script>alert('Gagal login: Kombinasi username dan password salah!');</script>
<?php
} }
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body style="background: #ffffff url(images/back1.jpg) no-repeat 100%;">
	...
	<nav class="navbar navbar-inverse navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="login.php">SELEKSI PENERIMA RASKIN/RASTRA</a>
		</div>
